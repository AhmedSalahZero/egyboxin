                            ...
                            <div class="tab-pane active" id="tab_0">
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-gift"></i>Assign To Courier</div>
                                    </div>
                                    <div class="portlet-body form assign_to_courier_data">
                                        ...
                                        <div class="form_data_assign" style="display: none" >
                                            ...
                                            <div class="confirm_assign_order_div">
                                                <button class="btn blue confirm_assign_order_btn"> Assign </button>
...
${  data.item.previous_status + ' ( ' + data.item.scheduling_times + ' )' }
