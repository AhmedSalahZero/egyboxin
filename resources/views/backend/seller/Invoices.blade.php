                                        ...
                                        <div class="form_data_for_debrief"  >
                                            <table class="table table-striped table-bordered table-hover table-header-fixed" >
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center"> Items Number </th>
...
{{--                                                    <th class="text-center"> Payment Method </th>--}}
                                                ...
                                                @forelse($invoices as $key=>$invoice)
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                {{$invoice->main_price}} EGP
                                                            </td>


                                                            <td>
                                                                {{$invoice->discount}} EGP
                                                            </td>
                                                            <td >
                                                                {{$invoice->total}} EGP
                                                            </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="text-center">
                                                                                                @if( ( $barcode->status =='Returned'))
                                                                                                    0
                                                                                                @else
                                                                                                    {{intval($barcode->price)}} EGP
                                                                                                @endif
                                                                                            </td>
                                                                                            <td class="text-center">
                                                                                                @if( ( $barcode->status =='Returned')  )
                                                                                                    {{$barcode->sub_area->return_price }} EGP</td>
                                                                                            @else
                                                                                                {{$barcode->shipping_price}} EGP</td>
                                                                                            @endif
